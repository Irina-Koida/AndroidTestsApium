...
namespace AndroidTestsApium.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("AutorizationPage")]
    public partial class AutorizationPageFeature
    {
...
#line 1 "AutorizationPage.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "AutorizationPage", null, ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Autorization user want to go to app")]
        [NUnit.Framework.CategoryAttribute("Autorization")]
        public virtual void AutorizationUserWantToGoToApp()
        {
            string[] tagsOfScenario = new string[] {
                    "Autorization"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Autorization user want to go to app", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 5
